...
<body>
    ...
    <form
    method="POST"
    action="../handlers/login_process.php"
    ...
    <span class="flex w-full">
        ...
        <button type="submit" class="w-44 h-12 bg-accent-500 text-white ml-auto">Login</button>
    </form>
    <p class="text-xs text-white text-center">Don't have an account? <a href="./register.php" class="text-accent-500">Register here.</a></p>
